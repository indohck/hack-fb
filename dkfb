...
def siapa():
	os.system('clear')
	nama = raw_input("\033[1;97mSiapa nama kamu cox ? \033[1;91m: \033[1;92m")
	if nama =="":
		...
		os.system('clear')
		jalan("\033[1;97mSelamat datang cox \033[1;92m" +nama+ "\n\033[1;97mTerimakasih telah menggunakan tools ini cox !!")
		time.sleep(1)
		loginSC()
...
def loginSC():
	...
	if username =="indo" and password =="hack":
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://www.youtube.com/channel/UCWdlSd5fyw6avH1tQydtFoQ')
				menu()
